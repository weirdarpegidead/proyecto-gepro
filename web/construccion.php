      ...
      <div class="large-12 columns">
        <div class="menu-centered">
          <ul class="menu">
            ...
            <li class="current-menu-item"><a href="http://desarrollo.ilia.cl/gepro/construccion/">Construccion</a></li>
            <li><a href="http://desarrollo.ilia.cl/gepro/ingenieria/">Ingenieria</a></li>
          </ul>
        </div>
      </div>
    </div>
