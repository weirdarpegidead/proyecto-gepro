      ...
      <div class="large-12 columns">
        <div class="menu-centered">
          <ul class="menu">
            ...
            <li class="current-menu-item"><a href="http://desarrollo.ilia.cl/gepro/internacional/">Internacional</a></li>
...
>>>>>>> Stashed changes
              ...
              <div class="large-12 columns">
                <ul class="no-bullet">
                <?php query_posts('category_name=int-entr-term' ); while ( have_posts() ) : the_post(); ?>
...
>>>>>>> Stashed changes
              ...
              <div class="large-12 columns">
                <ul class="no-bullet">
                <?php query_posts('category_name=int-vdc-term' ); while ( have_posts() ) : the_post(); ?>
                  <li><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></li>                
                <?php endwhile; wp_reset_query(); ?>
                </ul>
              </div>
...
>>>>>>> Stashed changes
              ...
              <div class="large-12 columns">
                <ul class="no-bullet">
                <?php query_posts('category_name=int-lp-term' ); while ( have_posts() ) : the_post(); ?>
                  <li><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></li>                
                <?php endwhile; wp_reset_query(); ?>
                </ul>
              </div>
...
>>>>>>> Stashed changes
              ...
              <div class="large-12 columns">
                <ul class="no-bullet">
                <?php query_posts('category_name=int-gest-prod-term' ); while ( have_posts() ) : the_post(); ?>
                  <li><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></li>                
                <?php endwhile; wp_reset_query(); ?>
                </ul>
              </div>
