      ...
      <div class="large-12 columns">
        <div class="menu-centered">
          <ul class="menu">
            ...
            <li class="current-menu-item"><a href="http://desarrollo.ilia.cl/gepro/ingenieria/">Ingeniería</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="tabs-content vertical" data-tabs-content="example-vert-tabs">
          <div class="tabs-panel is-active" id="panel1v">
            <div class="row contenido">
              ...
              <?php query_posts('category_name=ing-ent-act' ); while ( have_posts() ) : the_post(); ?>
              ...
              <div class="large-12 columns">
                <ul class="no-bullet">
                <?php query_posts('category_name=ing-ent-term' ); while ( have_posts() ) : the_post(); ?>
          ...
          <div class="tabs-panel" id="panel2v">
            <div class="row contenido">
              ...
              <?php query_posts('category_name=ing-esp-act' ); while ( have_posts() ) : the_post(); ?>
              <div class="large-4 columns text-center mascara">
                <a href="<?php echo get_permalink(); ?>"><?php if ( has_post_thumbnail() ) { the_post_thumbnail( 'blog' ); } ?></a>
                <h5><?php the_title(); ?></h5>
                <div class="row">
